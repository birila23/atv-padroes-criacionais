...
public class PersonagemBuilder {
    ...
    public PersonagemBuilder atributos(int forca, int inteligencia, int agilidade,  int vida,  int mana) {
        this.forca = forca;
    ...
    public PersonagemBuilder equipamento(Arma arma, Armadura armadura) {
        this.arma = arma;
